  ...
  let content = (
    <div css={indexStyle}>
      <div className="text-content">
        <h1>Hi, I'm Akhil.</h1>
        <h2>Technologist aspiring to build great products</h2>
        <h3>
          Associate Consultant @{" "}
          <a href="https://bain.com" target="_blank">
            Bain &amp; Company
          </a>
        </h3>
        <h3>
          ...
          , and{" "}
          <a href="https://www.glooko.com" target="_blank">
            Glooko
          </a>
        </h3>
        <h3>
          Former Design Chair @{" "}
          <a href="https://www.thecrimson.com" target="_blank">
            The Harvard Crimson
          </a>
        </h3>
      </div>
